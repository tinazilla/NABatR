...
Convert the project data extracted using query_nabat_gql and rename_raw_acoustic into Manual and Automatic
0/1 data for all species
```{r}
...
n_df = build_nights_df(acoustic_data = acoustic_project,
                       out_file      = './downloads/Observed_Nights_Acoustic.csv',
                       acoustic_type = 'manual')
